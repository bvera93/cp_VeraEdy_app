...
package com.samuwings.app.utils
...
import com.samuwings.app.api.RestResponse
import com.samuwings.app.base.BaseAdaptor
import com.samuwings.app.model.AddonsModel
import com.samuwings.app.model.LocationModel
import com.samuwings.app.utils.SharePreference.Companion.SELECTED_LANGUAGE
...
import com.samuwings.app.utils.SharePreference.Companion.setBooleanPref
                ...
                if (response.code() == 200) {
                    ...
                    if(restResponce.getStatus().equals("1")){
                        if(restResponce.getData()!!.getLang()!=null && restResponce.getData()!!.getLat()!=null){
                            val urlAddress = "http://maps.google.com/maps?q=" + restResponce.getData()!!.getLat() + "," + restResponce.getData()!!.getLang() + "(" + "Delivery App Platea21" + ")&iwloc=A&hl=es"
