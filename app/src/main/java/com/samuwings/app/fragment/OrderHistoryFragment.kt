...
import com.samuwings.app.activity.OrderDetailActivity
...
import com.samuwings.app.model.OrderHistoryModel
...
import com.samuwings.app.utils.Common.getDate
            ...
            object : BaseAdaptor<OrderHistoryModel>(activity!!, orderHistoryList) {
                ...
                override fun onBindData(
                    ...
                    if(orderHistoryList.get(position).getPayment_type()!!.toInt()==0){
                        tvPaymentType.text = "PAGO EN EFECTIVO"
