...
import com.samuwings.app.utils.SharePreference.Companion.userName
import com.samuwings.app.utils.SharePreference.Companion.userProfile
import com.samuwings.app.api.*
import com.samuwings.app.fragment.*
    ...
    override fun InitView() {
        ...
        if(intent.getStringExtra("pos")!=null){
            ...
            if(SharePreference.getBooleanPref(this@DashboardActivity,SharePreference.isLogin)){
                ...
                tvName!!.text ="Bienvenidos a Samu Wings."
